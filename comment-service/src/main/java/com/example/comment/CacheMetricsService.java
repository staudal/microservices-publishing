...
public class CacheMetricsService {
    ...
    private static final String COMMENT_CACHE_HITS = "metrics:comment:hits";
    private static final String COMMENT_CACHE_MISSES = "metrics:comment:misses";
    ...
    public void recordCommentCacheHit() {
        redisTemplate.opsForValue().increment(COMMENT_CACHE_HITS);
    }

    public void recordCommentCacheMiss() {
        redisTemplate.opsForValue().increment(COMMENT_CACHE_MISSES);
    }

    public CacheMetrics getCommentCacheMetrics() {
        Long hits = getLongValue(COMMENT_CACHE_HITS);
        Long misses = getLongValue(COMMENT_CACHE_MISSES);
