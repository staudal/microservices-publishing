...
public class ArticleService {
    ...
    public void processArticleQueue(ArticleQueueMessage message) {
        ...
        // Delete the draft after successful article creation via HTTP call
        String draftServiceUrl = "http://draft-service:8080/drafts/" + message.getDraftId();
        try {
            restTemplate.delete(draftServiceUrl);
            ...
            log.error("Failed to delete draft: draftId={}, error={}", message.getDraftId(), e.getMessage());
        }
    }
}
